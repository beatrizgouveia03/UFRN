...
\hypertarget{md_README}{}\label{md_README}\index{Graphs Simulation Project@{Graphs Simulation Project}}
\label{md_README_autotoc_md0}%
\Hypertarget{md_README_autotoc_md0}%
 Welcome to the Graphs Simulation project! This project provides a collection of graph algorithms implemented in C++. It serves as a comprehensive resource for learning and applying key operations on both graphs and directed graphs (digraphs).\hypertarget{md_README_autotoc_md1}{}\doxysection{\texorpdfstring{Table of Contents}{Table of Contents}}\label{md_README_autotoc_md1}
...
\item Contributing
\end{DoxyEnumerate}\hypertarget{md_README_autotoc_md2}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{md_README_autotoc_md2}
...
Each function and algorithm in this project aims to build a strong foundation in graph theory, helping to understand the relationships between vertices and edges, both in theoretical contexts and practical applications.\hypertarget{md_README_autotoc_md3}{}\doxysection{\texorpdfstring{Algorithms}{Algorithms}}\label{md_README_autotoc_md3}
...
\item \mbox{[} \mbox{]} (11) Função que determina se um grafo é conexo ou não\mbox{[}Davi\mbox{]}
...
\item \mbox{[} \mbox{]} (16) Determinação de articulações e blocos (biconectividade), utilizando obrigatoriamente a fu ão lowpt\mbox{[}Alisson\mbox{]}
...
\end{DoxyEnumerate}\hypertarget{md_README_autotoc_md5}{}\doxysection{\texorpdfstring{Compiling Methods}{Compiling Methods}}\label{md_README_autotoc_md5}
...
\end{DoxyEnumerate}\hypertarget{md_README_autotoc_md6}{}\doxysection{\texorpdfstring{Contributing}{Contributing}}\label{md_README_autotoc_md6}
